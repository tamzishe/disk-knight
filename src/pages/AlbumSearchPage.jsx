...
function AlbumSearchPage() {
  ...
  const handleCollect = () => {
    ...
    const albumCollection = JSON.parse(localStorage.getItem('localAlbumCollection')) || [];
    albumCollection.push(selectedAlbum);
    localStorage.setItem('localAlbumCollection', JSON.stringify(albumCollection));
